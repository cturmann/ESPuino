	...
	*/
	...
	constexpr const char accessPointNetworkSSID[] PROGMEM = "JohannaBox";     // Access-point's SSID
	...
	// Bluetooth
	constexpr const char nameBluetoothSinkDevice[] PROGMEM = "JohannaBox";        // Name of your ESPuino as Bluetooth-device
